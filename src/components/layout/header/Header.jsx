...
const MenuLinkButton = ({url='/', title='Home', onClose}) => (
              ...
              <DrawerContent>
                  ...
                  <DrawerBody>
                      ...
                      >
                          ...
                          <MenuLinkButton onClose={onClose} url='/courses' title='Browse All Courses'/>
                          <MenuLinkButton onClose={onClose} url='/request' title='Request a Course'/>
                          <MenuLinkButton onClose={onClose} url='/contact' title='Contact Us'/>
